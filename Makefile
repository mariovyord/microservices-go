...
up_build: build_broker build_auth build_logger build_listener build_mail build_front_linux
...
build_mail:
	...
	cd ./mailer && env GOOS=linux CGO_ENABLED=0 go build -o ${MAIL_BINARY} ./cmd/api
	@echo "Done!"
